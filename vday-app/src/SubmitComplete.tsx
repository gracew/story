    ...
    return (
        <div className="submit-complete">
            <div>
                ...
                <Button className="back-to-homepage" onClick={() => history.push("/")}>Back to homepage</Button>
                <p className="questions">Questions? Contact <a href="mailto:hello@storydating.com">hello@storydating.com</a></p>
            </div>
        </div>
    );
}
