  ...
  return (
    <div className="privacy">
      ...
      <p>
        ...
        accept and agree to be bound to these terms, you should not use the
        Service.
      </p>
      ...
      <ul>
        ...
        <li>
          You have never been convicted or pled no contest to a felony, sex
          crime, or any other crime involving violence, and that you are not
          required to register as a sex offender with any federal, state, or
      ...
      <ul>
        ...
        <li>
          Engage in any behavior that is abusive, harassing, indecent, profane,
          obscene, hateful or otherwise objectionable, including sexual
          misconduct;
        </li>
        <li>
          Spam or solicit money from other users, including without limitation
          operating a pyramid scheme, fraud, or other similar practice
        </li>
        <li>
          Share your account with other users, use the account of another user,
          or maintain more than one account
        </li>
        <li>
          Use the Service for any other harmful or nefarious purpose, including
          without limitation, any illegal purpose or any purpose prohibited by
          this agreement.
        </li>
        <li>
          Violate or infringe the rights of third parties, including privacy,
      ...
      <p>
        ...
        as any information you post, upload, display or otherwise make available
        on the Service or transmit to other members (collectively, “Your
        Content”).
      </p>
      <p>
        ...
        connection with Your Content. By sharing Your Content, you represent and
        warrant that Your Content does not infringe upon any third party's
        rights (including, without limitation, intellectual property rights and
        privacy rights).
      </p>
      <p>
        When you are matched with another user through the Service, some of Your
        Content, such as the “Fun Facts” you provide when you create an account,
        may be shared with the user you have been matched with (your “Matches”).
        Unless indicated otherwise, Your Content may be shared with your
        Matches, so make sure you are comfortable sharing Your Content before
        you add it to your profile. For more information on how your information
        is shared with your Matches, please review our{" "}
      ...
      <p>
        ...
        third parties online as you would under any other circumstances.
      </p>
      <p>
        We have the right to remove, edit, limit or block access to any of Your
        Content at any time, and we have no obligation to review Your Content.
      </p>
      ...
      <ul>
        ...
        <li>use our name in metatags, keywords and/or hidden text;</li>
        <li>
          create derivative works from Our Content or commercially exploit Our
        ...
        <li>
          ...
          Service, or cause others to do so; and
        </li>
        <li>
          use Our Content or Service in a way that violates any law or
          regulation
        </li>
      </ul>
      <h2>5. Privacy</h2>
      ...
      <p>
        If we terminate this Agreement and/or your access to the Services as a
        result of your violation of any applicable law or regulation, we may
        also, at our sole discretion, inform law enforcement or regulatory
        authorities of the circumstances surrounding such termination.
      </p>
      ...
      <p>
        ...
        you. We may even suspend the service entirely. If we suspend the
        service, we will notify you unless extenuating circumstances prevent us
        from doing so.{" "}
      </p>
      <p>
        ...
        effect on the Effective Date. In some cases, we may notify you of
        changes to the Terms via email. The most recent version of these Terms
        will always be available on our website and you should check this page
      ...
      <p>
        ...
        organisation – for example, this could include someone who buys our
        business. We will always tell you in writing if this happens.
      </p>
      <h2>9. Disclaimer</h2>
      <p>
      ...
      <p>
        ...
        OR THROUGH THE SERVICE WILL BE ACCURATE OR RELIABLE. YOUR USE OF THE
      ...
      <p>
        ...
        SUCH DAMAGES. IF YOU BECOME DISSATISFIED IN ANY WAY WITH THE SERVICE OR
        SITE, YOUR SOLE AND EXCLUSIVE REMEDY IS TO STOP YOUR USE OF THE SERVICE
        AND SITE.
      </p>
      <p>
        YOU HEREBY WAIVE ANY AND ALL CLAIMS ARISING OUT OF YOUR USE OF THE
        SERVICE OR SITE. BECAUSE SOME STATES DO NOT ALLOW THE DISCLAIMER OF
        IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN TYPES OF
        DAMAGES, THESE PROVISIONS MAY NOT APPLY TO YOU. IF ANY PORTION OF THIS
        LIMITATION ON LIABILITY IS FOUND TO BE INVALID OR UNENFORCEABLE FOR ANY
        REASON, THEN OUR AGGREGATE LIABILITY SHALL NOT EXCEED ONE HUNDRED
        DOLLARS ($100).
      </p>
      <p>
        THE LIMITATION OF LIABILITY HEREIN IS A FUNDAMENTAL ELEMENT OF THE BASIS
        OF THE BARGAIN AND REFLECTS A FAIR ALLOCATION OF RISK. THE SERVICE AND
        SITE WOULD NOT BE PROVIDED WITHOUT SUCH LIMITATIONS AND YOU AGREE THAT
        THE LIMITATIONS AND EXCLUSIONS OF LIABILITY, DISCLAIMERS AND EXCLUSIVE
      ...
      <p>
        ...
        fees, incurred by us arising out of or in any way connected with:
      </p>
      <ul>
        <li>Any negligent acts, omissions, or wilful misconduct by you,</li>
        <li>
          Your use of the Service or any information you provide while using the
          Service,
        </li>
      ...
      <p>
        ...
        required by us in the defence of any relevant claim.
      </p>
      ...
      <p>
        ...
        unenforceable or invalid for any reason, then such provision or portion
        thereof shall be modified or deleted in such manner as to render this
        Agreement as modified legal and enforceable to the maximum extent
